...
void loop()
{
  ...
  long Bp = (data[0] * 256) + data[1];
  long Bt = (data[4] * 256) + data[5];
  long Ct = (data[6] * 256) + data[7];
  long Bt2 = (data[8] * 256) + data[9];
  long Ct2 = (data[10] * 256) + data[11];
  long Ba = (data[12] * 256) + data[13];
  ...
  // Calliberation Cofficients
  long Ca = (data1[3] * 65536) + (data1[0] * 256) + data1[1];
  long Cp = (data1[2] * 65536) + (data[2] * 256) + data[3];
