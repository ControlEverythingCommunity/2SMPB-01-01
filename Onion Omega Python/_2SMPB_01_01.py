...
i2c.writeByte(0x70, 0x03, 0x14)
# 2SMPB-01-01 address, 0x70(112)
# Select OTP read register, 0x08(08)
#		0x25(37)	Enable OTP read
i2c.writeByte(0x70, 0x08, 0x25)
...
# Bt MSB, Bt LSB
data = i2c.readBytes(0x70, 0x26, 2)
...
# Ct MSB, Ct LSB
data = i2c.readBytes(0x70, 0x28, 2)
...
# Bt2 MSB, Bt2 LSB
data = i2c.readBytes(0x70, 0x2A, 2)
...
# Ct2 MSB, Ct2 LSB
data = i2c.readBytes(0x70, 0x2C, 2)
...
# Ba MSB, Ba LSB
data = i2c.readBytes(0x70, 0x2E, 2)
...
# Bp MSB, Bp LSB
data = i2c.readBytes(0x70, 0x22, 2)
...
# Cp MSB, Cp LSB
data1 = i2c.readBytes(0x70, 0x24, 2)

# Read data back from 0x32(50), 2 bytes
# Ca MSB, Ca LSB
data2 = i2c.readBytes(0x70, 0x32, 2)

# Read data back from 0x34(52), 2 bytes
# Cp SLSB, Ca SLSB
data3 = i2c.readBytes(0x70, 0x34, 2)
...
data = i2c.readBytes(0x70, 0x00, 3)
